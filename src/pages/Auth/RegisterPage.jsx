...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await RequestHandler(`${baseUrl}/userSignup`, {
                method: "POST",
                headers: {
        ...
        <section className={styles.pageLayout}>
            <div className={styles.card}>
                <form className={styles.inputWrapp} onSubmit={handleSubmit} >
                    ...
                    <Input name="email" label="Email" value={ data.email } handler={handleChange} type="email"  placeholder="Input Email"/>
                    ...
                    <Input name="phone_number" label="Phone Number" value={ data.phone_number } handler={handleChange} type="number"  placeholder="Input Phone Number"/>
